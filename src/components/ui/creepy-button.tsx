...
export const CreepyButton = ({
    ...
    return (
        <button
            className={cn(
                "relative min-w-[9em] rounded-xl bg-black dark:bg-white cursor-pointer outline-none select-none group tap-highlight-transparent",
                "focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-neutral-400 dark:focus-visible:ring-neutral-600",
                className
            )}
            onClick={onClick}
            onMouseMove={(e) => {
        ...
        >
            ...
            >
                {/* Left Eye */}
                <motion.span
                    className="relative w-[0.75em] bg-white dark:bg-black rounded-full overflow-hidden border border-black/10 dark:border-white/10"
                ...
                >
                    <span
                        className="absolute top-1/2 left-1/2 w-[0.375em] h-[0.375em] bg-black dark:bg-white rounded-full transition-transform duration-75 ease-out"
                        style={pupilStyle}
                    />
                </motion.span>
                {/* Right Eye */}
            ...
            <motion.span
                className={cn(
                    "absolute inset-0 block rounded-xl font-bold tracking-wider",
                    "bg-white text-black shadow-[inset_0_0_0_0.125em_rgba(0,0,0,1)]",
                    "dark:bg-black dark:text-white dark:shadow-[inset_0_0_0_0.125em_rgba(255,255,255,1)]",
